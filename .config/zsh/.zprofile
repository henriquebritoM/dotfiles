...
# export WINEPREFIX="$XDG_DATA_HOME/wineprefixes/default" # I don't use wine, but this is nice to keep
export DATE=$(date "+%A, %B %e  %_I:%M%P")
export DOCKER_CONFIG="$XDG_CONFIG_HOME"/docker

# batcat = bat on debian, as bat is a name already taken on debian
...
# export PATH="$XDG_CONFIG_HOME/scripts:$PATH" # don't know how to use it
path+=("$CARGO_HOME/bin")
